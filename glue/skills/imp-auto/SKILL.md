---
name: imp-auto
description: Toggle autonomous mode for current shipment. Use when IMP wants to enable/disable autonomous work.
---
...
|------|--------|----------|
| **Auto** | `auto_implementing` | IMP continues until shipment complete. |
| **Manual** | `implementing` | IMP can stop freely. |
